...
module.exports = class HFServer {
  constructor({
    ...
    app.use('/v1/definitions', require('./routes/algo-definitions')(this))
    debug('Hf api listening on %d', this._hfPort)
  }

  setAlgoDefinitions(aos) {
    debug('creating and settings new algo host service')
