...
class StrategyManager {
  ...
  async execute (parsedStrategy = {}, strategyOptions = {}) {
    ...
    const { capitalAllocation, maxDrawdownPerc, stopLossPerc } = strategyOptions
    ...
    this.pub(['strategy.live_execution_started', gid, { ...strategyOptions, startedOn }])
  ...
  getActiveStrategies () {
    ...
    return Object.fromEntries(activeStrategies.map((strategy) => {
      ...
      const { strategyOptions, startedOn } = value
      return [
        key,
        { ...strategyOptions, startedOn }
      ]
    }))
  }
