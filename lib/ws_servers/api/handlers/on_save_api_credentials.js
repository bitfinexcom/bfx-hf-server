...
const startConnections = require('../start_connections')

module.exports = async (server, ws, msg) => {
  const { d, db, wsURL, restURL, hostedURL, reconnectAlgoHost } = server
  ...
  if (ws.algoWorker.updateAuthArgs) {
    ws.algoWorker.updateAuthArgs({
      apiKey,
      apiSecret
    })
  }
