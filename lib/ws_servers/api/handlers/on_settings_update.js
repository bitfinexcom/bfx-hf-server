...
module.exports = async (server, ws, msg) => {
  ...
  const [, authToken, dms, ga, showAlgoPauseInfo, showOnlyFavoritePairs, rebootAutomatically, theme, joinBetaProgram] = msg
  ...
  if (oldSettings.dms !== settings.dms) {
    ...
    await connectionManager.updateDms(server, ws, dms)
