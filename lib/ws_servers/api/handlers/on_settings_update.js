...
module.exports = async (server, ws, msg) => {
  ...
  const validRequest = validateParams(ws, {
    ...
    // showOptInModal: { type: 'bool', v: showOptInModal },
    optinCrashReports: { type: 'bool', v: optinCrashReports },
    optinBFXAnalytics: { type: 'bool', v: optinBFXAnalytics }
  })
  ...
  try {
    ...
    // update connections on settings update
    await connectionManager.onSettingsUpdate(server, ws, oldSettings, settings)
  } catch (e) {
