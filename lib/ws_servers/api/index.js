...
const onDazaarExecute = require('./handlers/on_dazaar_execute')
...
const onDazaarList = require('./handlers/on_dazaar_list')
const onDazaarRemove = require('./handlers/on_dazaar_remove')
  ...
  constructor ({
    ...
    super({
      ...
      msgHandlers: {
        ...
        'exec.dazaar': onDazaarExecute,
        'dazaar.ls': onDazaarList,
        'dazaar.rm': onDazaarRemove,
