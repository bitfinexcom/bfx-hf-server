...
const onSaveFavouriteTradePairs = require('./handlers/on_save_favourite_trade_pairs')
const onFavouriteTradePairsRequest = require('./handlers/on_favourite_trade_pairs_request')
  ...
  constructor ({
    ...
    super({
      ...
      msgHandlers: {
        ...
        'get.favourite_trade_pairs': onFavouriteTradePairsRequest,
        ...
        'favourite_trade_pairs.save': onSaveFavouriteTradePairs
      }
    })
