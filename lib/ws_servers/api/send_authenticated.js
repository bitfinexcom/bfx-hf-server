...
module.exports = async (ws, db, marketData, d, opts) => {
  ...
  await ws.algoWorker.start({ apiKey: key, apiSecret: secret, userId: DEFAULT_USER })
  ws.clients.bitfinex = openAuthBitfinexConnection({ ws, apiKey: key, apiSecret: secret, userSettings, d, opts })
}
