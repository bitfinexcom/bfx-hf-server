...
module.exports = ({ ws, apiKey, apiSecret, authToken, dms, d, wsURL, restURL, isPaper, dmsScope = 'app', sendDataToMetricsServerFunc }) => {
  ...
  client.onData(payload => {
    ...
    switch (msgType) {
      ...
      case 'on': {
        return onOrderNew(ws, isPaper, dmsScope, msgData, sendDataToMetricsServerFunc)
      }
      case 'ou': {
        return onOrderUpdate(ws, isPaper, dmsScope, msgData, sendDataToMetricsServerFunc)
      }
      case 'oc': {
        return onOrderClose(ws, isPaper, dmsScope, msgData, sendDataToMetricsServerFunc)
      }
      case 'n': {
